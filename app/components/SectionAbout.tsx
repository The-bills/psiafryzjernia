export const SectionAbout = () => {
  return (
    <section
      id="about"
      className="flex flex-col items-center justify-center w-full pt-16 pb-0 px-6 bone2"
    >
      <h1 className="text-4xl md:text-6xl pb-16 underline decoration-1 underline-offset-8 text-stone-950">
        O NAS!
      </h1>
      <p className={pStyles}>
