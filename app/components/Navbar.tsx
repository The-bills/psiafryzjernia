    ...
    return (
        <nav className="flex flex-col md:flex-row w-full sticky top-0 bg-bone1 items-center text-lg z-50" style={{overflow: 'hidden'}}>
          <div className="flex w-full md:justify-between justify-start md:gap-0 gap-8 items-center p-4 md:p-0">
            ...
            <button className="md:hidden ml-auto" onClick={toggleMenu} style={{color:"black"}}>
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16m-7 6h7"></path>
              </svg>
            </button>
          </div>
          <div className={`flex flex-col md:flex-row md:items-center md:gap-3 ${isOpen ? 'block' : 'hidden'} w-full md:w-auto text-graphite1`}>
          ...
          <img src="logo_pl_200.png" alt="orly_groomingu" className="hidden md:block h-12 mr-auto ml-8 mr-8" />
        </nav>
      );
};
